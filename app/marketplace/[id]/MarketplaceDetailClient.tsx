...
export default function MarketplaceDetailClient({ marketplace, marketplaceId }: MarketplaceDetailClientProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F7F5F2] dark:bg-[#0A0A0A]">
            ...
            <div className="flex gap-3">
              {repoUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-[#1E1E1E] hover:bg-[#2A2A2A] dark:bg-white dark:hover:bg-gray-100 text-white dark:text-black text-sm rounded-lg font-medium transition-colors"
                >
      ...
      <footer className="mt-auto bg-white dark:bg-[#0A0A0A] border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center">
