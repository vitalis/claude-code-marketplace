          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div className="flex-1">
              ...
              <p className="mt-2 text-sm sm:text-base text-gray-700 dark:text-gray-300" role="doc-subtitle">
                {marketplace.metadata?.description || 'Browse open-source extensions for Anthropic\'s Claude Code editor'}
              </p>
            </div>
            <a
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-center text-gray-500 dark:text-gray-400 text-xs mb-4">
              Open-source extensions for Anthropic's Claude Code editor. No downloads required.
            </p>
